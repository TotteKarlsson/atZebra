================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : TheRealBarcode Project Overview
===============================================================================

The application wizard has created this TheRealBarcode application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TheRealBarcode application.

TheRealBarcode.vcproj
...
TheRealBarcode.h
    ...
    project specific headers and declares the CTheRealBarcodeApp application class.

TheRealBarcode.cpp
    This is the main application source file that contains the application
    class CTheRealBarcodeApp.


TheRealBarcodeppc.rc
...
res\TheRealBarcodeppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\TheRealBarcode.ico
...
TheRealBarcodeDlg.h, TheRealBarcodeDlg.cpp - the dialog
    These files contain your CTheRealBarcodeDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named TheRealBarcode.pch and a precompiled types file named StdAfx.obj.
